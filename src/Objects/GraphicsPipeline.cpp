...
void GraphicsPipeline::init(void)
{
	...
	VkViewport viewport = { 0, 0, static_cast<float>(Context::window.extent.width), static_cast<float>(Context::window.extent.height), 0.f, 1.f };
	VkRect2D scissors = { {0, 0}, Context::window.extent.width, Context::window.extent.height };
